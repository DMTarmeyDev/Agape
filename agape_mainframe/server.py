...
from .bridge import R24, answer_intake, ensure_r24, improve_intake, intake as bridge_intake, job as bridge_job, open_result_folder, prepare_intake, projects as bridge_projects, revise_intake, revise_work, run_work
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            if u.path=="/api/recent":return send_json(self,200,{"ok":True,"items":recent_work(int((q.get("limit") or [50])[0]))})
