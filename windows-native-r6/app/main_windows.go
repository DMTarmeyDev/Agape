...
var (
	...
	startupErr      error
	coreRoot        string
	windowClassName = "AgapeNativeWebView2HostR6"
)
...
func ensureSingleInstance() (uintptr, bool) {
	name := utf16Ptr("Local\\AgapeNativeWebView2HostR6")
...
func main() {
	logLine("------------------------------------------------------------")
	logLine("AGAPE_NATIVE_WEBVIEW_R6_START")
	...
	go backendReady()
	messageLoop()
	logLine("AGAPE_NATIVE_WEBVIEW_R6_EXIT")
}
