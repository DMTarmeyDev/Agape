...
class V31ClosureTests(unittest.TestCase):
    def test_identity(self):
        import config
        self.assertEqual(config.BUILD,'DMT-CORE-V3.1-EARLY-ALPHA-R1')
    ...
    def test_menu_branding(self):
        ...
        for tab in ('Chat','Projects','Project Loop','AI Models','Database','Terminal History','Templates','Development'): self.assertIn('>'+tab+'<',t)
