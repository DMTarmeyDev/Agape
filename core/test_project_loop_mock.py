...
try:
    ...
    win_command = r'"C:\Users\DMTarmey\AppData\Local\Programs\Python\Python312\python.exe" test_value.py'
    win_parts = project_loop._split_test_command(win_command, windows=True)
    assert win_parts == [r'C:\Users\DMTarmey\AppData\Local\Programs\Python\Python312\python.exe', 'test_value.py'], win_parts
