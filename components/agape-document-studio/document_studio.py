...
HTML=r"""<!doctype html><html><head><meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate"><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="Expires" content="0"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Agape Document Studio R31.10</title><style>
...
</style></head><body><header><h1>Agape Document Studio R31.10</h1><p>OpenDocument first - LibreOffice powered - verified templates - persistent document history.</p></header><div id="workProgressWrap" class="work-progress"><div class="work-progress-box"><div class="work-track"><div id="workProgressFill" class="work-fill"></div></div><div id="workProgressLabel" class="work-label">Ready.</div></div></div><div class="wrap">
...
def serve(port,open_browser=True):
    generate_templates();db();srv=ThreadingHTTPServer(("127.0.0.1",port),Handler);print("AGAPE_DOCUMENT_STUDIO_R31_10=READY",flush=True)
